...
const STUDENTS = ['Глеб', 'Даша', 'Софа', 'Акбар', 'Маша', 'Милена', 'Глеб мск', 'Андрей', 'Набережных', 'Полушкина', 'Тимур', 'Таня', 'Злата','Святослав', 'Лиза', 'Ксюша', 'Ярослав', 'Саша', 'Эми', 'Ева', 'Арсентий', 'Аля', 'Вика'];
const PRICES = [
