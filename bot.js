...
const TEACHERS = ['Босс', 'Саша', 'Артём', 'Наташа', 'Олеся', 'Юля', 'Никита'];
const STUDENTS = ['Глеб', 'Даша', 'Софа', 'Акбар', 'Маша', 'Милена', 'Глеб мск', 'Андрей', 'Набережных', 'Полушкина', 'Тимур', 'Таня', 'Злата','Святослав', 'Лиза', 'Ксюша', 'Ярослав', 'Саша', 'Эми', 'Ева', 'Арсентий', 'Аля', 'Злата', 'Богдана','Вика'];
const PRICES = [
